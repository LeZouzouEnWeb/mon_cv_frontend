...
<body class="min-h-screen">
    ...
    <!-- Modal Confirmation -->
    <div id="confirmation-modal" class="modal hidden fixed inset-0 z-50 overflow-y-auto" aria-labelledby="confirmation-title" role="dialog" aria-modal="true">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            <!-- Overlay -->
            <div class="modal-overlay fixed inset-0 bg-gray-900 bg-opacity-75 transition-opacity" aria-hidden="true"></div>
            ...
            <div class="modal-content inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div id="confirmation-icon" class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full sm:mx-0 sm:h-10 sm:w-10">
                            <!-- Icon sera ajouté dynamiquement -->
                        </div>
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                            <h3 class="text-lg leading-6 font-heading font-bold text-gray-900" id="confirmation-title">
                                <!-- Titre sera ajouté dynamiquement -->
                            </h3>
                            <div class="mt-2">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="button" id="confirmation-modal-close" class="btn btn-primary w-full sm:w-auto">
                        OK
                    </button>
                </div>
            </div>
